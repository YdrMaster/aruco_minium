...
int main(int argc, char** argv)
{
    try
    {
        ...
        if (argc < 4 || cml["-h"])
        {
            ...
            cerr << "Usage: (in.avi|live[:camera_index(e.g 0 or 1)]|net[:http://admin:admin@192.168.3.76:8081/video]) marksetconfig.yml camera_intrinsics.yml [optional_arguments]  "
